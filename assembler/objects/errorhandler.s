	...
	.text
.Ltext0:
	.file 0 "/home/tnvc/Documents/assembler/assembler" "../src/utils/errorhandler.cpp"
	.section	.rodata
	.align 4
...
.LC1:
	.string	"Error"
	.text
	.globl	_Z11handleErrorPKcz
	.type	_Z11handleErrorPKcz, @function
_Z11handleErrorPKcz:
.LFB13:
	.file 1 "../src/utils/errorhandler.cpp"
	.loc 1 21 1
	.cfi_startproc
	endbr64
	pushq	%rbp
...
.L3:
	...
	movl	$1, %edx
	movq	%rax, %rdi
	call	_ZL13handleMessagePKcP13__va_list_tagiS0_
	.loc 1 29 1
	nop
	leave
	.cfi_def_cfa 7, 8
	...
	.cfi_endproc
.LFE13:
	.size	_Z11handleErrorPKcz, .-_Z11handleErrorPKcz
	.section	.rodata
.LC2:
	.string	"Warning"
	.text
	.globl	_Z13handleWarningPKcz
	.type	_Z13handleWarningPKcz, @function
_Z13handleWarningPKcz:
.LFB14:
	.loc 1 32 1
	.cfi_startproc
	endbr64
...
.L6:
	...
	.cfi_endproc
.LFE14:
	.size	_Z13handleWarningPKcz, .-_Z13handleWarningPKcz
	.section	.rodata
.LC3:
...
.LC4:
	.string	"%s: "
	.text
	.type	_ZL13handleMessagePKcP13__va_list_tagiS0_, @function
_ZL13handleMessagePKcP13__va_list_tagiS0_:
.LFB15:
	.loc 1 43 1
	.cfi_startproc
	endbr64
...
.L8:
	...
	movl	-20(%rbp), %eax
	movl	%eax, %edi
	call	_Z18setForegroundColori@PLT
	.loc 1 49 9
	call	_Z15getProgrammNamev@PLT
	movq	%rax, %rsi
	leaq	.LC4(%rip), %rax
	movq	%rax, %rdi
	movl	$0, %eax
	...
	.cfi_endproc
.LFE15:
	.size	_ZL13handleMessagePKcP13__va_list_tagiS0_, .-_ZL13handleMessagePKcP13__va_list_tagiS0_
.Letext0:
	...
	.file 10 "../include/utils/coloroutput.h"
	.file 11 "include/settings.h"
...
.Ldebug_macro0:
	...
	.long	.Ldebug_macro13
	.byte	0x4
	.file 23 "/usr/include/x86_64-linux-gnu/bits/types.h"
	.byte	0x3
	.uleb128 0x26
	.uleb128 0x17
	.byte	0x5
	...
	.long	.Ldebug_macro55
	.byte	0x4
	.file 68 "../include/utils/errorhandler.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x44
	.byte	0x5
...
.LASF745:
	.string	"SEEK_DATA 3"
.LASF1417:
	.string	"CONSOLECOLOR_BRIGHT_GREEN"
.LASF519:
...
.LASF1416:
	.string	"CONSOLECOLOR_BRIGHT_RED"
.LASF701:
...
.LASF1351:
	.string	"strtoull"
.LASF1422:
	.string	"CONSOLECOLOR_BRIGHT_WHITE"
.LASF117:
...
.LASF1419:
	.string	"CONSOLECOLOR_BRIGHT_BLUE"
.LASF1088:
...
.LASF1429:
	.string	"printf"
.LASF1421:
	.string	"CONSOLECOLOR_BRIGHT_CYAN"
.LASF87:
...
.LASF1415:
	.string	"CONSOLECOLOR_BRIGHT_BLACK"
.LASF414:
...
.LASF1418:
	.string	"CONSOLECOLOR_BRIGHT_YELLOW"
.LASF1387:
	.string	"long double"
.LASF559:
...
.LASF1420:
	.string	"CONSOLECOLOR_BRIGHT_MAGENTA"
.LASF353:
...
.LASF0:
	.string	"../src/utils/errorhandler.cpp"
