	...
	.text
.Ltext0:
	.file 0 "/home/tnvc/Documents/assembler/assembler" "src/assembler.cpp"
	.section	.rodata
	.align 4
...
_ZL24DEFAULT_TARGET_FILE_NAME:
	...
	.align 8
.LC14:
	.string	"int compile(Assembler*, String*, size_t, FILE*)"
.LC15:
...
.LC21:
	...
	.align 8
.LC22:
	.string	"Incorrect arguments in line [%d]"
.LC23:
	.string	"Unknown syntax in line [%d]"
.LC24:
	.string	"Unknown cmd[%s] in line %d!!"
	.text
	.globl	_Z7compileP9AssemblerP6StringmP8_IO_FILE
	.type	_Z7compileP9AssemblerP6StringmP8_IO_FILE, @function
_Z7compileP9AssemblerP6StringmP8_IO_FILE:
.LFB13:
...
.L2:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 35 150 discriminator 1
	call	abort@PLT
.L3:
	.loc 1 36 8
	cmpq	$0, -96(%rbp)
	jne	.L4
	.loc 1 36 35 discriminator 1
	movl	$36, %r8d
	leaq	.LC14(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC15(%rip), %rax
...
.LBB6:
	...
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	_ZL9parseArgsP9AssemblerPcPm
	testl	%eax, %eax
	setne	%al
	.loc 1 88 11
	testb	%al, %al
...
.L31:
	...
	movq	-80(%rbp), %rax
	addq	%rdx, %rax
	.loc 1 267 42 discriminator 1
	movq	(%rax), %rdx
	.loc 1 267 47 discriminator 1
	movl	-60(%rbp), %eax
	cltq
	.loc 1 267 57 discriminator 1
	addq	%rdx, %rax
	movzbl	(%rax), %eax
...
.LBE62:
	...
	movl	$0, %eax
.L36:
	.loc 1 306 1 discriminator 15
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
.LFE13:
	.size	_Z7compileP9AssemblerP6StringmP8_IO_FILE, .-_Z7compileP9AssemblerP6StringmP8_IO_FILE
	.section	.rodata
	.align 8
.LC25:
	.string	"int parseArgs(Assembler*, char*, size_t*)"
.LC26:
	.string	"string"
.LC27:
	.string	"pc"
...
.LC29:
	.string	"%3s"
	.text
	.type	_ZL9parseArgsP9AssemblerPcPm, @function
_ZL9parseArgsP9AssemblerPcPm:
.LFB14:
	.loc 1 309 1
	.cfi_startproc
	endbr64
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 310 155 discriminator 1
	call	abort@PLT
.L41:
	.loc 1 311 8
	cmpq	$0, -64(%rbp)
	jne	.L42
	.loc 1 311 31 discriminator 1
	movl	$311, %r8d
	leaq	.LC25(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC15(%rip), %rax
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 311 149 discriminator 1
	call	abort@PLT
.L42:
	.loc 1 312 8
	cmpq	$0, -72(%rbp)
	jne	.L44
	.loc 1 312 27 discriminator 1
	movl	$312, %r8d
	leaq	.LC25(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC15(%rip), %rax
...
.L53:
	...
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	_ZL9findLabelPK9AssemblerPKcPi
	testl	%eax, %eax
	setne	%al
	.loc 1 359 7
	testb	%al, %al
...
.L57:
	...
	movl	$0, %eax
	call	__isoc99_sscanf@PLT
	.loc 1 387 17 discriminator 1
	testl	%eax, %eax
	je	.L58
	.loc 1 387 17 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L59
.L58:
	.loc 1 387 17 discriminator 4
	movl	$0, %eax
.L59:
	.loc 1 387 3 is_stmt 1 discriminator 6
	testb	%al, %al
	je	.L60
	.loc 1 389 16
	movq	-24(%rbp), %rax
...
.L62:
	...
	cmpb	$93, %al
	je	.L66
	.loc 1 424 16 is_stmt 0 discriminator 3
	movl	$1, %eax
	jmp	.L67
.L66:
	.loc 1 424 16 discriminator 4
	movl	$0, %eax
.L67:
	.loc 1 424 3 is_stmt 1 discriminator 6
	testb	%al, %al
	je	.L68
	.loc 1 425 15
	movl	$4, %eax
...
.L68:
	...
	testb	%al, %al
	jne	.L69
	.loc 1 427 38 discriminator 2
	movq	-24(%rbp), %rax
	movzbl	(%rax), %eax
	andl	$-128, %eax
	.loc 1 427 19 discriminator 2
	testb	%al, %al
	jne	.L69
	.loc 1 428 14
	movl	$4, %eax
...
.L70:
	...
	movl	$0, %eax
.L71:
	.loc 1 434 1 discriminator 2
	leave
	.cfi_def_cfa 7, 8
	ret
	.cfi_endproc
.LFE14:
	.size	_ZL9parseArgsP9AssemblerPcPm, .-_ZL9parseArgsP9AssemblerPcPm
	.type	_ZL12getRegNumberPKc, @function
_ZL12getRegNumberPKc:
.LFB15:
	.loc 1 437 1
	.cfi_startproc
	endbr64
	...
	cmpb	$114, %al
	jne	.L73
	.loc 1 440 31 discriminator 1
	movq	-24(%rbp), %rax
	addq	$2, %rax
	movzbl	(%rax), %eax
	.loc 1 440 22 discriminator 1
	cmpb	$120, %al
	je	.L74
.L73:
	.loc 1 441 13
...
.L75:
	...
	.cfi_endproc
.LFE15:
	.size	_ZL12getRegNumberPKc, .-_ZL12getRegNumberPKc
	.section	.rodata
	.align 8
.LC30:
	.string	"int findLabel(const Assembler*, const char*, int*)"
.LC31:
	.string	"name"
.LC32:
	.string	"address"
	.text
	.type	_ZL9findLabelPK9AssemblerPKcPi, @function
_ZL9findLabelPK9AssemblerPKcPi:
.LFB16:
	.loc 1 452 1
	.cfi_startproc
	endbr64
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 453 155 discriminator 1
	call	abort@PLT
.L79:
	.loc 1 454 8
	cmpq	$0, -32(%rbp)
	jne	.L80
	.loc 1 454 29 discriminator 1
	movl	$454, %r8d
	leaq	.LC30(%rip), %rax
	movq	%rax, %rcx
	leaq	.LC15(%rip), %rax
...
.L85:
	...
	jmp	.L84
.L83:
	.loc 1 457 3 discriminator 2
	addq	$1, -8(%rbp)
.L82:
	.loc 1 457 37 discriminator 1
	movq	-24(%rbp), %rax
	movq	4112(%rax), %rax
	.loc 1 457 24 discriminator 1
	cmpq	%rax, -8(%rbp)
	jb	.L85
.LBE66:
	.loc 1 467 12
...
.L84:
	...
	.cfi_endproc
.LFE16:
	.size	_ZL9findLabelPK9AssemblerPKcPi, .-_ZL9findLabelPK9AssemblerPKcPi
.Letext0:
	...
	.file 13 "include/settings.h"
	.file 14 "../include/utils/stringsutils.h"
	.file 15 "/usr/include/ctype.h"
	.file 16 "/usr/include/string.h"
	.file 17 "/usr/include/stdio.h"
	.file 18 "../include/utils/systemlike.h"
	.file 19 "../include/utils/errorhandler.h"
...
.Ldebug_macro0:
	...
	.long	.LASF1404
	.byte	0x4
	.file 75 "../include/utils/asserts.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x4b
	.byte	0x5
...
.LASF1501:
	.string	"SOFTCPU_HLT"
.LASF1479:
	.string	"ASSEMBLER_UNKNOWN_SYNTAX"
.LASF623:
...
.LASF1481:
	.string	"ASSEMBLER_INCORRECT_ARGUMENTS"
.LASF124:
...
.LASF1483:
	.string	"ASSEMBLER_INCORRECT_LABEL"
.LASF1071:
...
.LASF1482:
	.string	"ASSEMBLER_OUT_OF_MEMORY"
.LASF785:
